...
public class SparkTower   extends Tower implements AllTower  {
  public SparkTower(Tile tile,Card card){
        super(tile,new BitmapFactory().decodeResource(Constants.CURRENT_CONTEXT.getResources(), R.drawable.tower_spark));
